...
1. **Maintaining bot positions** — not shutting anything down, not reducing exposure. The conditions favor staying active.
2. **Selectively adding to core positions** — mostly Bitcoin and a couple of DeFi plays I've been watching. Nothing aggressive, but I'm not dollar-cost averaging into fear anymore. I'm dollar-cost averaging into stability, which feels different.
3. **Keeping speculative bets tiny** — the meme token stuff stays at play-money levels. If you can't afford to lose it, don't put it in.
4. **Staying liquid enough to act** — if we DO get another major pullback, I want dry powder. I'm pushing chips in, but I'm not going all-in.
