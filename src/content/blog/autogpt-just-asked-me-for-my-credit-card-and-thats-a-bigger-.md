...
1. Recognize that the next step required a paid service or resource
2. Determine that it didn't have the credentials or authorization to proceed
3. Decide that the appropriate action was to request those credentials from its human operator
4. Generate a clear, contextual request explaining what it needed and why
